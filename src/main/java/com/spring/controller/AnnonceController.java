...
public class AnnonceController {
    ...
    @GetMapping("/user/{proprietaire}")
    public List<Annonce> getAnnoncesByUser(@PathVariable String proprietaire) {
        return annonce_service.getAnnonceByUser(proprietaire);
    }
